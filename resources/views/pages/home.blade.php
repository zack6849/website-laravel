<x-base-page title="Index" noheader="true" vue="true">
    <div class="flex container mx-auto mb-6">
        <div class="hidden lg:visible lg:block mr-10">
            <img alt="Zachary Craig" src="{{asset('img/profile.jpg')}}" class="rounded-full w-48">
        </div>
        <div>
    ...
    <div class="container mx-auto my-5">
       ...
       <div class="flex flex-wrap justify-between">
            <project-card
                title="YAPI (Yet Another PHP Image)"
                image="{{asset('img/undraw_developer_activity_re_39tg.svg')}}"
                github="https://github.com/zack6849/yapi"
            >
            ...
            <project-card
                title="ShipStation PHP Wrapper"
                image="{{asset('img/logistics_x4dc.svg')}}"
                github="https://github.com/zack6849/ship-station"
                package-link="https://packagist.org/packages/zack6849/ship-station"
            >
                <p>
                    An updated (and (sort of) maintained) fork of
                    <a href="https://github.com/michaelbonds/ship-station">michaelbonds/ship-station</a>
                </p>
                <p>
                    Designed to programmatically access the
                    <a href="https://www.shipstation.com/docs/api/" target="_blank">ShipStation REST API</a>
                    via PHP with Guzzle
                </p>
            </project-card>
            <project-card
                title="AlphabotV2"
                image="{{asset('img/Artificial_intelligence_oyxx.svg')}}"
                github="https://github.com/zack6849/AlphabotV2"
            >
                <p>
                    An extensible Java IRC bot with a node-based permissions system, meant for basic channel
                    administration and utilities, featuring a full plugin system with runtime classloading</p>
            </project-card>
        </div>
    </div>
</x-base-page>
