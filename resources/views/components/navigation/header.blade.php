    ...
    <div class="mx-auto w-full max-w-screen-2xl">
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="block lg:hidden">
                <button @click='toggle'  class="flex items-center px-3 py-2 border rounded nav-link border-nav-400 hover:border-white">
                    <svg class="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                </button>
            </div>
            <div :class="shownav ? 'block': 'hidden'" class="block w-full flex-grow lg:flex lg:w-auto lg:items-center">
                <div class="text-sm lg:flex-grow items-center">
                    <a href="{{route('home')}}" class="block lg:inline-block lg:mt-0 nav-link mr-4">
                        Home
                    </a>
                    <div class="group lg:relative block lg:inline-block lg:mr-4">
                        <span class="hidden lg:flex items-center gap-1 lg:mt-0 nav-link">
                            Tools
                            <svg class="h-3 w-3 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5.516 7.548c.436-.446 1.043-.48 1.576 0L10 10.405l2.908-2.857c.533-.48 1.141-.446 1.574 0 .436.445.408 1.197 0 1.615-.406.418-4.695 4.502-4.695 4.502a1.095 1.095 0 0 1-1.576 0S5.919 9.581 5.516 9.163c-.409-.418-.436-1.17 0-1.615z"/></svg>
                        </span>
                        <div class="pl-4 lg:pl-0 lg:hidden lg:group-hover:block lg:absolute lg:bg-white lg:rounded lg:shadow-lg lg:py-1 lg:w-48 lg:z-10">
